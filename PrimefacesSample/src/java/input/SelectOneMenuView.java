...
public class SelectOneMenuView {
    ...
    public void init() {
        ...
        g1.setSelectItems(new SelectItem[] {new SelectItem("BMW", "BMW"),
            new SelectItem("Mercedes", "Mercedes"),
            new SelectItem("Miranda", "Miranda"),
            new SelectItem("Marcos", "Marcos"),
            new SelectItem("Minus", "Minus"),
